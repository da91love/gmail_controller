...
class SlackMsgCreator:
    ...
    @staticmethod
    def get_slack_delivery_request_post_block(pic, export_no, buyer_name, address, recipient, phone_num, requested_arrival_date, bill_type, folder_id, delivery, delivery_type, remark):
