...
def app_api_gmail_remind_sender(event, context=None):
    ...
    for latest_sent_contact in latest_sent_contacts:
        gmail_thread_id, gmail_msg_id, receiver_email, sender_email, add_to_sys, t_key, status, progress, pic, created_at \
            = itemgetter('gmail_thread_id', 'gmail_msg_id', 'receiver_email', 'sender_email', 'add_to_sys', 't_key', 'status', 'progress','pic', 'created_at')(latest_sent_contact)
